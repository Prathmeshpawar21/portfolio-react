...
import { Filter } from 'bad-words'; // ← THIS IS CORRECT
...
import "./Contact.module.scss"; // <-- Move styles to a CSS file and import it here
...
const Contact = () => {
  ...
  // ⬇️ Move GSAP animation directly into onClick handler for button:
  ...
  useEffect(() => {
    if (mailerResponse !== "not initiated") {
      setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      {/* REMOVE Next.js style tag, move CSS to Contact.css or similar */}
    </section>
  );
};
